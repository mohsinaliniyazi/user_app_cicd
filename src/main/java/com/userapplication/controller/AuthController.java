...
import com.userapplication.payload.request.LoginRequest;
import com.userapplication.payload.request.SignupRequest;
import com.userapplication.payload.response.JwtResponse;
import com.userapplication.payload.response.MessageResponse;
import com.userapplication.repository.RoleRepository;
import com.userapplication.repository.UserRepository;
import com.userapplication.security.jwt.JwtUtils;
import com.userapplication.security.service.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		User userProfile = signUpRequest.getUser();
		if (userRepository.findByFirstName(userProfile.getFirstName()).isPresent()) {
